...
<section class="hero-area-three bgs-cover bgc-lighter pt-210 rpt-150 pb-100"
    ...
    <div class="container">
        <div class="banner-inner pt-70 rpt-60 text-dark">
            <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Privacy Policy
            </h1>
        </div>
    </div>
</section>
<section class="pt-130 rpt-100 pb-95 rpb-65">
    <div class="container">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Draggify.</p>
            </li>
            <li>
        ...
        <ul>
            <li>email: contact@draggify.com</li>
        </ul>
    </div>
</section>
@include('footer')
