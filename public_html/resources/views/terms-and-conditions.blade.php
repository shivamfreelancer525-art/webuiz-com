...
<section class="hero-area-three bgs-cover bgc-lighter pt-210 rpt-150 pb-100"
    ...
    <div class="container">
        <div class="banner-inner pt-70 rpt-60 text-dark">
            <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Terms & Conditions
            </h1>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <ul>
            <li>
                ...
                <p>email: contact@draggify.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="https://draggify.com/contact-us.php"
                        rel="external nofollow noopener" target="_blank">https://draggify.com/contact-us.php</a></p>
            </li>
        </ul>
    </div>
</section>
